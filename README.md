...
`npm i` в корне
`npm i` в packages/browser-extensions
`npm i` в packages/browser-extensions/src/popup

## Запуск
`npm start` в packages/browser-extensions
...
## Установка зависимостей
`npm i` в packages/backend
Убедитесь что команда `python` работает в консоле

## Запуск
`npm start` в packages/backend
